...
const RestaurantProfileScreen = ({ navigation }) => {
  ...
  const handleSaveProfile = async () => {
    ...
    if (!name || !description || !address || !phoneNumber || !cuisineType || !location) {
  ...
  return (
    ...
    >
      <Header 
        title={translations.createRestaurantProfile} 
        showBackButton 
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.headerText}>{translations.restaurantDetails}</Text>
          <Text style={styles.subtitle}>{translations.restaurantProfileDescription}</Text>
        </View>
        ...
        <View style={styles.formContainer}>
          ...
          <Input
            ...
            placeholder={translations.restaurantDescriptionPlaceholder}
            multiline
            numberOfLines={4}
            required
          />
          ...
          <Text style={styles.sectionTitle}>{translations.restaurantSpecifics}</Text>
          
          <Input
            label={translations.cuisineType}
            value={cuisineType}
            onChangeText={setCuisineType}
            placeholder={translations.cuisineTypePlaceholder}
            required
          />
