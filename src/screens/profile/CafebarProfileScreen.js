...
const CafebarProfileScreen = ({ navigation }) => {
  const { user } = useAuth();
  ...
  const handleSaveProfile = async () => {
    ...
    if (!name || !description || !address || !phoneNumber || !location) {
  ...
  return (
    ...
    >
      <Header 
        title={translations.createCafebarProfile} 
        showBackButton 
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.headerText}>{translations.cafebarDetails}</Text>
          <Text style={styles.subtitle}>{translations.cafebarProfileDescription}</Text>
        </View>
        ...
        <View style={styles.formContainer}>
          ...
          <Input
            ...
            placeholder={translations.cafebarDescriptionPlaceholder}
            multiline
            numberOfLines={4}
            required
          />
          ...
          <Text style={styles.sectionTitle}>{translations.cafebarSpecifics}</Text>
          
          <Input
            label={translations.specialties}
            value={specialties}
            onChangeText={setSpecialties}
            placeholder={translations.specialtiesPlaceholder}
          />

          <Input
            label={translations.atmosphere}
            value={atmosphere}
            onChangeText={setAtmosphere}
            placeholder={translations.atmospherePlaceholder}
          />
          ...
          <Input
            ...
            placeholder={translations.capacityPlaceholder}
...
export default CafebarProfileScreen;
